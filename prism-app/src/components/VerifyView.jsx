      ...
      <div style={{ width: "100%", maxWidth: "520px" }}>
        ...
        {sigStatus === "valid" && (
          <div style={{ padding: "12px 16px", borderRadius: "8px", marginBottom: "20px", background: "#0f1e10", border: "1px solid #2a6040", display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            <div>
              <div style={{ fontSize: "12px", fontWeight: 700, color: "#40e080", letterSpacing: "0.1em" }}>VALID PRISM RECORD — SIGNATURE VERIFIED</div>
              <div style={{ fontSize: "10px", color: "#70b090" }}>Record ID: <strong style={{ fontFamily: "monospace", color: "#90d0b0" }}>{id}</strong> · Data has not been tampered with</div>
            </div>
          </div>
        )}
        {sigStatus === "invalid" && (
          <div style={{ padding: "12px 16px", borderRadius: "8px", marginBottom: "20px", background: "#1e0f0f", border: "1px solid #602020", display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            <div>
              ...
              <div style={{ fontSize: "10px", color: "#b07070" }}>The record data does not match its signature. Do not trust this record.</div>
            </div>
          </div>
        )}
        {sigStatus === "unsigned" && (
          <div style={{ padding: "12px 16px", borderRadius: "8px", marginBottom: "20px", background: "#1a1608", border: "1px solid #604020", display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            <div>
              <div style={{ fontSize: "12px", fontWeight: 700, color: "#d0a040", letterSpacing: "0.1em" }}>LEGACY RECORD — NO SIGNATURE</div>
              <div style={{ fontSize: "10px", color: "#a08050" }}>Record ID: <strong style={{ fontFamily: "monospace", color: "#c0a060" }}>{id}</strong> · Generated before tamper-evident signing was added</div>
            </div>
          </div>
        )}
        ...
        <div style={{
          ...
          <div style={{ padding: "12px 24px", background: "#f8fafc", fontSize: "9px", color: "#8090a0", lineHeight: 1.5 }}>
            This record was generated by PRISM — Precision Rating Index of Specimen Minerals.
            ...
            Photos and extended documentation notes are embedded in the original printed record only.
            <br /><br />
            Record ID: <strong style={{ fontFamily: "monospace" }}>{id}</strong>
            <br />
